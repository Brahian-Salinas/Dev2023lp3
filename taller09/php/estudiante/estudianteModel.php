<?php
    class estudianteModel{
        ...
        public function listar() {
            ...
            $sql = 'SELECT idEstudiantes,nombre,apellido,codigoCurso,
            if(codigoCurso=1,"VUE",if(codigoCurso=2,"RUBY", "PHP")) AS curso From estudiantes ORDER BY idEstudiantes DESC';
        ...
        public function buscar($idEstudiante) {
            $sql =  'SELECT idEstudiantes,nombre,apellido,codigoCurso,
            if(codigoCurso=1,"VUE",if(codigoCurso=2,"RUBY", "PHP")) AS curso From estudiantes WHERE idEstudiantes = :idEstudiantes';
            $statement = $this->PDO->prepare($sql);
            $statement->bindParam(':idEstudiantes',$idEstudiante);
